...
import { Lock, AlertTriangle, CheckCircle2, DollarSign, TrendingUp, Download, X, RefreshCw } from 'lucide-react'

type TabCierre = 'diario' | 'anual'
      ...
      <div className="mb-12">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-black bg-gradient-to-r from-amber-400 to-yellow-400 bg-clip-text text-transparent">
                Cierre de Período
              </h1>
