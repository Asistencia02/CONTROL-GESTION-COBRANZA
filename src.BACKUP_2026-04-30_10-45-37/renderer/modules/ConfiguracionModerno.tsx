...
import { Settings, Save, AlertCircle, Edit2, Plus, Download, Upload, RefreshCw, Receipt, Building2 } from 'lucide-react'
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-2">
                      Próximo: <strong>{String(config.numero_actual).padStart(config.padding, '0')}</strong>
                    </p>
                  </div>
                  <button
