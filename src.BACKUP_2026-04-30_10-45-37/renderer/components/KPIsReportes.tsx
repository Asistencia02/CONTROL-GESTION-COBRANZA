  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
      ...
      <div className="lg:col-span-1 p-6 bg-gradient-to-br from-slate-800/80 to-indigo-900/30 backdrop-blur-xl border border-indigo-500/30 rounded-xl shadow-lg shadow-indigo-500/10 hover:border-indigo-500/60 transition-all group">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-4xl font-black text-transparent bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text">
        ...
        <div className="pt-4 border-t border-indigo-500/20 space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-green-400 font-bold">{formatoMoneda(totalPagosRegistrados)}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-slate-400">Pendiente:</span>
            <span className="text-red-400 font-bold">{formatoMoneda(totalDeudasVencidas)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="lg:col-span-1 p-6 bg-gradient-to-br from-slate-800/80 to-blue-900/30 backdrop-blur-xl border border-blue-500/30 rounded-xl shadow-lg shadow-blue-500/10 hover:border-blue-500/60 transition-all">
        <p className="text-xs text-slate-400 font-semibold tracking-wider mb-4">GESTIÓN DE COBRO</p>
        <div className="mb-6">
        ...
        <p className="text-xs text-slate-400 text-center">De lo recaudable</p>
      </div>
      ...
      <div className={`lg:col-span-1 p-6 bg-gradient-to-br from-slate-800/80 to-red-900/30 backdrop-blur-xl border rounded-xl shadow-lg transition-all ${ 
        ...
        <div className="pt-4 border-t border-red-500/20 space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-slate-300 font-bold">{estudiantesActivos} activos</span>
          </div>
          <div className="flex justify-between text-sm">
      ...
      <div className="p-6 bg-gradient-to-br from-slate-800/80 to-green-900/30 backdrop-blur-xl border border-green-500/30 rounded-xl shadow-lg shadow-green-500/10 hover:border-green-500/60 transition-all group">
        ...
        <p className="text-xs text-slate-400 mt-4">Disponible en caja</p>
      </div>

      {/* 5. DEUDAS VENCIDAS */}
      <div className="p-6 bg-gradient-to-br from-slate-800/80 to-orange-900/30 backdrop-blur-xl border border-orange-500/30 rounded-xl shadow-lg shadow-orange-500/10 hover:border-orange-500/60 transition-all group">
        <div className="flex items-start justify-between mb-4">
          <div>
            <p className="text-xs text-slate-400 font-semibold tracking-wider mb-1">POR COBRAR</p>
            <p className="text-3xl font-black text-orange-400">{formatoMoneda(totalDeudasVencidas)}</p>
          </div>
          <div className="p-3 bg-orange-500/20 rounded-lg group-hover:bg-orange-500/30 transition">
            <Clock size={24} className="text-orange-400" />
          </div>
        </div>
        <p className="text-xs text-slate-400 mt-4">Cuentas por cobrar</p>
      </div>

      {/* 6. PROMEDIO DEUDA POR ESTUDIANTE */}
      <div className="p-6 bg-gradient-to-br from-slate-800/80 to-purple-900/30 backdrop-blur-xl border border-purple-500/30 rounded-xl shadow-lg shadow-purple-500/10 hover:border-purple-500/60 transition-all group">
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            <p className="text-3xl font-black text-purple-400">{formatoMoneda(promedioDeudasEstudiante)}</p>
          </div>
