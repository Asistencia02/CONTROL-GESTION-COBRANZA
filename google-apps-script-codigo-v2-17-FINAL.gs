// ==================== GOOGLE APPS SCRIPT - FULL AUTO v2.17 FINAL ====================
...
function ejecutarFullAutoManual() {
  try {
    ...
    Logger.log("\n" + "=".repeat(70));
    Logger.log("🚀 INICIANDO FULL AUTO v2.17 MULTI-INSTITUCIÓN (MANUAL) - CON METODO/TALONARIO");
...
function ejecutarFullAutoInterno() {
  try {
    Logger.log("\n" + "=".repeat(70));
    Logger.log("🚀 EJECUTANDO LÓGICA INTERNA v2.17 (METODO + TALONARIO + PAGOS DIVIDIDOS)");
    Logger.log("=".repeat(70));
...
function ejecutarFullAutoTrigger() {
  try {
    Logger.log("\n" + "=".repeat(70));
    Logger.log("🚀 TRIGGER AUTOMÁTICO - FULL AUTO v2.17 (METODO + TALONARIO)");
    Logger.log("=".repeat(70));
