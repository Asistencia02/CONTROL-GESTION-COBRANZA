// ==================== GOOGLE APPS SCRIPT - FULL AUTO v2.15 OPTIMIZADO ====================
...
function ejecutarFullAutoManual() {
  try {
    ...
    Logger.log("\n" + "=".repeat(70));
    Logger.log("🚀 INICIANDO FULL AUTO v2.15 MULTI-INSTITUCIÓN (MANUAL) - OPTIMIZADO");
...
function ejecutarFullAutoInterno() {
  try {
    Logger.log("\n" + "=".repeat(70));
    Logger.log("🚀 EJECUTANDO LÓGICA INTERNA v2.15 (OPTIMIZADO)");
    Logger.log("=".repeat(70));
...
function ejecutarFullAutoTrigger() {
  try {
    Logger.log("\n" + "=".repeat(70));
    Logger.log("🚀 TRIGGER AUTOMÁTICO - FULL AUTO v2.15 (OPTIMIZADO)");
    Logger.log("=".repeat(70));
...
// ✅ v2.15: Optimizado - Batch INSERT/UPDATE
...
// ✅ v2.15: Optimizado - Query batch en lugar de loop individual
...
// ✅ v2.15: Optimizado - Batch query de pagos con in() filter
