...
export const ConfiguracionModerno: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8">
      ...
      <ModalAgregarInsumo isOpen={modalAbrirInsumo} onClose={() => setModalAbrirInsumo(false)} onAgregar={(insumo) => agregarInsumo({ ...insumo, institucion_id: institucionActiva.id })} categorias={[...new Set(insumos.map((i) => i.categoria).filter(Boolean))]} />
