...
import { Plus, Edit2, Trash2, AlertCircle, Package, DollarSign, TrendingUp, Lock, Settings } from 'lucide-react'
...
export const KioscoConfigTab: React.FC = () => {
  ...
  const [mostrando, setMostrando] = useState<'lista' | 'agregar' | 'editar' | 'caja'>('lista')
  ...
  return (
    <div className="space-y-6">
      ...
      {/* KPIs - PRODUCTOS */}
      {(mostrando === 'lista' || mostrando === 'agregar' || mostrando === 'editar') && (
      ...
      {/* TAB: CAJA CHICA */}
      {mostrando === 'caja' && (
        <div className="p-6 bg-slate-800/50 border border-slate-700/50 rounded-lg space-y-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-3 bg-green-500/20 rounded-lg">
              <Lock size={24} className="text-green-400" />
            </div>
            <h2 className="text-2xl font-bold text-white">Configuración de Caja Chica</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-slate-700/30 border border-green-500/50 rounded-lg space-y-4">
              <div>
